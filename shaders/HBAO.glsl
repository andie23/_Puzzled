...
//USER VARIABLES-----------------------------------------------
const float intensity = 6.8;            //Intensity of the AO effect
const float sampleRadius = 2.2;         //Radius of the AO, bigger values need more performance
...
const float angleBias = 0.66;            //Brightens up the AO effect to reduce noise and artifacts
